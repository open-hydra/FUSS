...
FUSS is free and open-source software licensed under the GNU General Public License v3.0 (GPL-3.0).

## Quick Summary

!!! info "License at a Glance"
    - ✅ **Use** — Use FUSS for any purpose
    - ✅ **Modify** — Change the source code as needed
    - ✅ **Distribute** — Share FUSS with others
...
- **Download and use** FUSS without restrictions
- **Use FUSS in research**, including published work
- **Use FUSS commercially** in your business or organisation
- **Modify FUSS** to suit your needs

### As a Distributor

If you distribute FUSS (modified or unmodified):
...
By contributing to FUSS:

- You grant FUSS permission to use your contributions
...
FUSS (GPL-3.0) is compatible with:
...
!!! warning "License Compatibility"
    When combining FUSS with other software, ensure all licenses are compatible.

## Dependencies and Their Licenses

FUSS uses several dependencies, each with its own license:
...
- **In the repository:** [LICENSE](https://github.com/open-hydra/FUSS/blob/main/LICENSE) file
- **Online:** [gnu.org/licenses/gpl-3.0.html](https://www.gnu.org/licenses/gpl-3.0.html)

## Warranty Disclaimer

!!! warning "No Warranty"
    FUSS is provided "as is" without warranty of any kind, either expressed or implied. See the full license for complete warranty disclaimer.
